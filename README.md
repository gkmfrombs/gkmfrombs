...
<p align="center">
  ...
  <a href="https://github.com/gkmfrombs">GitHub</a> •
  <a href="mailto:gudduiit.m1315@gmail.com">Email</a>
</p>

---

### 🚀 Currently
- 🔭 Working on a **Gen-AI software engineering project**
- 🌱 Learning **Deep Learning, C Programming, and Industry 4.0**
- 👯 Open to collaborating on **AI / ML projects**
- 🤔 Seeking guidance toward a **stable software / data science role**
- 💬 Ask me about **Python, Flask, ML basics, backend logic**
...
### 📌 Projects
- **Library Management System v2** — Flask, Vue.js, Celery, Redis  
- **Library Management System v1** — Flask  
- **ML Regression Project (Kaggle)** — scikit-learn  
- **Business Data Capstone** — Python, Excel  
